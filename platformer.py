...
def reset_level(level):
    ...
    if path.exists(f'level{level}.pkl'):
        pickle_in = open(f'level{level}.pkl', 'rb')
...
class World():
    ...
    def __init__(self, data):
        ...
        dirt_img = pygame.image.load('dirt.png.1')
    ...
    if main_menu == True:
        ...
        if game_over == 1:
            ...
            if level <= max_levels: 
                ...
                draw_text('WITH', font, blue, (screen_width // 2) - 100, screen_height // 2-100)
                draw_text( str(score) + ' COINS!', font, blue, (screen_width // 2) - 140, screen_height // 2 )
                draw_text('YOU WIN', font, blue, (screen_width // 2) - 140, screen_height // 2-200)
                if restart_button.draw():
                    level = 1
                    world_data = []
                    world = reset_level(level)
